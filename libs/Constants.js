...
export function getCoinYoutubeUrl(coinName) {
  switch (coinName) {
    case 'Bitcoin':
      return 'https://coinmarketcap.com/ko/currencies/bitcoin/';
    case 'Ethereum':
      return 'https://coinmarketcap.com/ko/currencies/ethereum/';
    case 'XRP':
      return 'https://coinmarketcap.com/ko/currencies/ripple/';
    case 'EOS':
      return 'https://coinmarketcap.com/ko/currencies/eos/';
    default:
      return 'https://coinmarketcap.com/ko/currencies/bitcoin/';
  }
}
